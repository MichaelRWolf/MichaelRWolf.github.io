...
*Suggested opening line:* "Some of what shaped how I think: ants, a marching band, a book of knots, and a three-year argument on a mailing list."

I have done some thinking. Here's what I believe. Done mostly for myself. Wanted to share it.

These are the people, places, organizations, and ideas that shaped how I think and work. Not a complete list. Not in order of importance. Just what I keep returning to.

---

## Nature

Momma Nature is my oldest teacher. I keep coming back to her because she has already solved most of the problems I encounter. How do you coordinate thousands of independent actors with no central control? Ask an ant colony. How do you build something resilient without over-engineering it? Look at a watershed. How do you balance consistency with variation? Study a forest.

What I took from nature is not metaphor — it is *method*. Observe carefully. Notice patterns. Notice where the pattern breaks. Nothing in nature is exactly identical to anything else, but the underlying structures repeat everywhere. That turns out to be true in software, in organizations, and in music.

---

## People

**Larry Wall and Damian Conway** — A lively time of open argumentation that proved to be very productive. Larry wrote the Apocalypses — design documents for each major feature of Perl 6. Damian wrote the Exegeses — detailed explorations and implementations for the rest of us. High rigor. High entertainment. A great pair. I know programming better for having been party to those discussions. They designed a language for human brains, not for the convenience of the compiler.

**Randall Schwartz** showed me that hard things can be made approachable without being dumbed down.[^schwartz] He had a gift for meeting you where you were and walking you somewhere new before you noticed you'd moved. That is a teaching skill worth studying.
...
**Michael Feathers, Emily Bache, and Llewellyn Falco** — Michael defined the term and gave us the framework: change internal structure without changing external behavior.[^feathers] A vocabulary for discussion and a catalog of refactorings that has passed the test of time (25+ years). Llewellyn and Emily built on that foundation, pushing the state of practice and making it accessible — to people, and to teams. In effect, the Adapter Pattern between theory and practice.

---

## Organizations

**AT&T Bell Labs** (Kernighan, Ritchie, and the Unix crew) gave us the philosophy of small tools that do one thing well and compose with other tools. That philosophy has outlasted every "integrated solution" that was supposed to replace it. The shell pipeline is still one of the most powerful programming models ever invented.
...
**Sustainable Ballard.**[^sustainableballard] Three peace activists, frustrated that the Iraq War was driven in part by oil dependence, got tired of being against things and asked: *What are we for?* That question sparked chickens, potluck meals, goats, local banking as a service rather than extractive usury — and a neighborhood-scale demonstration that a different future was possible to build. Founded in 2003, it became the first neighborhood sustainability group in Seattle and a founding organization of SCALLOPS (Sustainable Communities All Over Puget Sound). Not protesting. Not opposing. Making. The proof-of-concept approach to civilization: if you want to live in a different world, start living in it.

---

## Human Interactions

**Liberating Structures** (Keith McCandless and the Seattle user group) gave me a framework I didn't know I was missing.[^ls_book][^ls_web] Human interaction at work is designed — either intentionally or by default. Most organizations accept the default: status meetings, presentations, open discussions dominated by the loudest voices. Liberating Structures is a catalog of alternative structures: small precise formats that change *who talks*, *when*, and *to whom*, producing outcomes the defaults cannot reach. This is not soft stuff. It is engineering applied to conversation.
...
[^norman]: Norman, D. A. (2013). *The design of everyday things* (Rev. and expanded ed.). Basic Books. (Original work published 1988)

[^gof]: Gamma, E., Helm, R., Johnson, R., & Vlissides, J. (1994). *Design patterns: Elements of reusable object-oriented software.* Addison-Wesley.

[^mead]: Mead, C., & Conway, L. (1980). *Introduction to VLSI systems.* Addison-Wesley.

[^ashley]: Ashley, C. W. (1944). *The Ashley book of knots.* Doubleday.
